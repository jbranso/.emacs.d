...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("evalutated" "evaluated" nil 0)
    ("exiciting" "exciting" nil 0)
    ("extention" "extension" nil 2)
    ("extentions" "extensions" nil 0)
    ("fileIsOk" "fileIsOk" nil 1)
    ("flyspell" "flyspell" nil 6)
