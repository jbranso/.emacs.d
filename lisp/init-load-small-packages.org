...
I also don't really need scroll-bar-mode enabled with ediff.
#+BEGIN_SRC emacs-lisp
  (add-hook 'ediff-load-hook #'(lambda () (interactive) (scroll-bar-mode -1)))
  (add-hook 'ediff-after-setup-windows-hook #'(lambda () (interactive) (scroll-bar-mode -1)))
