...
It also checks to see if the system is a Mac.  If so, then it disables flyspell.
#+BEGIN_SRC emacs-lisp
...
:END:
I'd like to have company mode complete my filenames for me:  http://emacs.stackexchange.com/questions/3654/filename-completion-using-company-mode#3666
#+BEGIN_SRC emacs-lisp
...
* css
:PROPERTIES:
:ID:       F5E4A752-5719-4EDB-A17D-DEB2789ABCEF
:END:
...
* tramp
:PROPERTIES:
:ID:       F53529F8-A06E-4350-82BF-4362B4771BA6
:END:
#+BEGIN_SRC emacs-lisp
...
* projectile
:PROPERTIES:
:ID:       FAD5FA48-0022-4EF7-8F2F-992A2300F7FD
:END:
So I can search for my files in my projects.
#+BEGIN_SRC emacs-lisp
