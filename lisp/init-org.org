...
This should besntaeh at least it ought to be eh? very very very cool This should be very very very cool This should be very very very cool This should be very very very cooYes I suppose that it is very very cool! l This should be very very very cool
...
Unfortunately, org-bullets was removed from org-contrib.  I'm not sure why.
...
Make org show inline images by default.  aka a link to a file will show the image, so instead of seeing
[[./path/to/file.png]]
...
see the heading and you accidentally kill a line without knowing it. This might not be supported for evil-mode
...
#+END_SRC
 ...
 Activate org speed commands.  When cursor is on heading, pressing a single key can activate certain commands in Emacs mode.  This can be useful on a mobile device.  I'm on a computer, so I don't need this.
 #+BEGIN_SRC emacs-lisp
...
*** My agenda setqs
:PROPERTIES:
:ID:       b0f8613f-9568-4569-868d-71fd735bd941
:END:
